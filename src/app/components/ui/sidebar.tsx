  ...
  return (
    <aside style={{
      ...
      <div style={{
        ...
        <div style={{ fontSize: 15, fontWeight: 800, color: isDark ? '#f8fafc' : '#0f172a', letterSpacing: '-0.02em' }}>
          Field Service
        </div>
        <div style={{ fontSize: 11, color: isDark ? '#64748b' : '#94a3b8', marginTop: 2, fontWeight: 500 }}>
          Management System
        </div>
      </div>
